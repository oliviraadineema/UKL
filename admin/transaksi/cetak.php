...
<body>
    <?php
        include '../koneksi.php';
        $sql = "select transaksi.*, paket.jenis, paket.harga, user.nama_user as nama_user, member.nama as nama_member,member.alamat, member.tlp, detail_transaksi.qty
        from transaksi
        ...
        join paket on paket.id = detail_transaksi.id_paket
        where transaksi.id = ".$_GET['id_transaksi'];
                //echo $sql;
    ...
    ?>
		...
		<article>
			...
			<table class="balance">
                ...
                <tr>
					<th><span >Kasir</span></th>
					<td><span data-prefix></span><span><?php echo $data['nama_user']; ?></span></td>
				</tr>
			</table>
		</article>
